...
export class AgentLoopOrchestrator {
  ...
  private buildStepSystemPrompt(
    ...
    return [
      ...
      '',
      'CREATING A WEBSITE — exact sequence:',
      '1. check_environment → get viteRecommendedVersion',
      ...
      '   - Full hero section with a real background image from Unsplash',
      '   - Navbar with logo and navigation links',
      '   - 3-4 feature/service cards with images',
      '   - Footer with contact info',
      '   - Brand colours from the user\'s request applied via inline styles',
      '5. write_file → REPLACE src/index.css with full professional CSS',
      '6. start_dev_server → starts server in background, returns { url, pid }',
      '7. Report the URL back to the user',
      '',
      'SOURCING IMAGES — use Unsplash Source URLs (no API key needed):',
      '  https://source.unsplash.com/1600x900/?solar,energy',
      '  https://source.unsplash.com/800x600/?renewable,technology',
      'Embed URL directly in JSX <img src="..."> or CSS background-image.',
      '',
      '⚠️ NEVER use run_command with script "dev" or "start" — those block forever.',
      '⚠️ ALWAYS use start_dev_server to run the project and get a live URL.',
      '',
      'Guidelines:',
